Public Class Form3
    ...
    Private Sub OpreaRYDataBase(bmbh As String)
        ...
        DataGridView1.Columns(7).HeaderText = "资产来源"
        DataGridView1.Columns(8).HeaderText = "购置数量"
        DataGridView1.Columns(9).HeaderText = "单价"
        DataGridView1.Columns(10).HeaderText = "总价"
        DataGridView1.Columns(11).HeaderText = "资产状态"
        DataGridView1.Columns(12).HeaderText = "部门编号"
        DataGridView1.Columns(13).HeaderText = "部门名称"
        DataGridView1.Columns(14).HeaderText = "责任人"
        DataGridView1.Columns(15).HeaderText = "存放位置"
        DataGridView1.Columns(16).HeaderText = "备注"
        DataGridView1.Columns(17).HeaderText = "备用1"
        DataGridView1.Columns(18).HeaderText = "备用2"
        DataGridView1.Columns(19).HeaderText = "备用3"
        DataGridView1.Columns(20).HeaderText = "备用4"
        DataGridView1.Columns(21).HeaderText = "备用5"
        DataGridView1.Columns(22).HeaderText = "备用6"
        DataGridView1.Columns(23).HeaderText = "备用7"
        DataGridView1.Columns(24).HeaderText = "备用8"
        DataGridView1.Columns(25).HeaderText = "备用N1"
        DataGridView1.Columns(26).HeaderText = "备用N2"
        DataGridView1.Columns(27).HeaderText = "备用N3"
        DataGridView1.Columns(28).HeaderText = "备用N4"
        DataGridView1.Columns(29).HeaderText = "备用N5"
        DataGridView1.Columns(30).HeaderText = "备用N6"
        DataGridView1.Columns(31).HeaderText = "流转记录"
        DataGridView1.Columns(32).HeaderText = "入库编号"
